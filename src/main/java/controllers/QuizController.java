        ...
        quizList.setCellFactory(lv -> new ListCell<>() {
            ...
            protected void updateItem(Quiz quiz, boolean empty) {
                ...
                if (empty || quiz == null) {
                    ...
                    titleLabel.getStyleClass().add("quiz-item-title");
                    ...
                    editBtn.getStyleClass().addAll("journal-list-btn", "journal-list-btn-soft");
                    manageBtn.getStyleClass().addAll("journal-list-btn", "journal-list-btn-soft");
                    takeBtn.getStyleClass().addAll("journal-list-btn", "journal-list-btn-primary");
                    deleteBtn.getStyleClass().addAll("journal-list-btn", "journal-list-btn-danger");
                    ...
                    hBox.getStyleClass().add("quiz-item-row");
