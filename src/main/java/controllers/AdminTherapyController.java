...
public class AdminTherapyController {
    ...
    @FXML private TableColumn<TherapySession, String> colPsy;  // ✅ String to show therapist name
    ...
    public void initialize() {
        ...
        colPsy.setCellValueFactory(cd -> new SimpleStringProperty(getTherapistName(cd.getValue().getPsychologistId())));  // ✅ Shows name instead of ID
    ...
    // ✅ HELPER: Get therapist name from ID
    private String getTherapistName(int id) {
        return switch (id) {
            case 1 -> "Dr. Mark Thompson";
            case 2 -> "Dr. Lina Ben Ali";
            case 3 -> "Dr. Sami Gharbi";
            default -> "Unknown";
        };
    }
}